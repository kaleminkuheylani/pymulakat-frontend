...
export default function OAuthButtons({ returnUrl, mode = "login" }: OAuthButtonsProps) {
  ...
  const googleLabel = mode === "register" ? "Google ile Kaydol" : "Google ile Devam Et";
  const githubLabel = mode === "register" ? "GitHub ile Kaydol" : "GitHub ile Devam Et";
