...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      // 2026-07-23: SEO restart — specific (binary, IDE, interpreter, derleyici) →
      //   commercial + generic (yazilima giris, kodlama sozlugu, programlama temelleri).
      // DA 1 site icin spesifik terimler sifir trafik. Kullanici niyetine odaklaniyor.
      "yazilima giris",
      "kodlama sozlugu",
