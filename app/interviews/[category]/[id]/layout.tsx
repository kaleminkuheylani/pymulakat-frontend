...
const LIB_DESCRIPTIONS: Record<string, string> = {
  ...
  "data-structures": "Veri yapıları mülakat soruları: list, dict, set, tuple, frozenset, deque, heapq, generators, itertools. Mulakat prensibi: hangi veri yapisini kullanacagina SEN karar verirsin. Counter, defaultdict, OrderedDict, bisect, sorted gibi koleksiyonlar.",
  "list-dict": "Temel liste ve sozluk uygulamaları mülakat soruları: siralama, filtreleme, arama, dict islemleri.",
  algorithms: "Algoritma mülakat soruları: iki isaretci, binary search, sliding window, sorting, stack/queue, recursion, DP. LeetCode easy/medium seviye Türkçe sorular.",
